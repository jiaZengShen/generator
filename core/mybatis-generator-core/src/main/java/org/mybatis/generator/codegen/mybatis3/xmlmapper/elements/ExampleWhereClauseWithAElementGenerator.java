 ...
 * 
 */
public class ExampleWhereClauseWithAElementGenerator extends
        AbstractXmlElementGenerator {


    public ExampleWhereClauseWithAElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        XmlElement answer = new XmlElement("sql"); //$NON-NLS-1$
            ...
            answer.addAttribute(new Attribute(
                    "id", introspectedTable.getExampleWhereCaluseWithAId())); //$NON-NLS-1$
    ...
    private XmlElement getMiddleForEachElement(
        ...
        when.addElement(new TextElement("and A.${criterion.condition}")); //$NON-NLS-1$
        ...
        sb.setLength(0);
        sb.append("and A.${criterion.condition} #{criterion.value"); //$NON-NLS-1$
        if (typeHandled) {
