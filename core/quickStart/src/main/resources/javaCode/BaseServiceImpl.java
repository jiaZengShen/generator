...
public abstract class BaseServiceImpl<Mapper, Record, Example> implements BaseService<Record, Example> {
	...
	@Override
	public int deleteByExample(Example example)  throws CommonException{
		try {
			...
			DynamicDataSource.clearDataSource();
			throw new CommonException("countByExample exception");
		}
	}

	@Override
	public int deleteByPrimaryKey(String id)  throws CommonException{
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
	...
	@Override
	public int deleteByPrimaryKey(Integer id)  throws CommonException{
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
			Method deleteByPrimaryKey = mapper.getClass().getDeclaredMethod("deleteByPrimaryKey", id.getClass());
			Object result = deleteByPrimaryKey.invoke(mapper, id);
	...
	@Override
	public int insert(Record record)  throws CommonException{
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
	...
	@Override
	public int insertSelective(Record record)  throws CommonException{
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
	...
	@Override
	public int updateByExampleSelective(@Param("record") Record record, @Param("example") Example example)  throws CommonException{
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
	...
	@Override
	public int updateByExampleWithBLOBs(@Param("record") Record record, @Param("example") Example example) throws CommonException {
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
	...
	@Override
	public int updateByExample(@Param("record") Record record, @Param("example") Example example)  throws CommonException{
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
	...
	@Override
	public int updateByPrimaryKeySelective(Record record)  throws CommonException{
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
	...
	@Override
	public int updateByPrimaryKeyWithBLOBs(Record record)  throws CommonException{
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
	...
	@Override
	public int updateByPrimaryKey(Record record)  throws CommonException{
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
	...
	@Override
	public int deleteByPrimaryKeys(String ids)  throws CommonException{
		try {
	...
	public List<TreeNode> getTreeData(@Param("example") Example example) throws CommonException {
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.SLAVE.getName());
			Method getTreeData = mapper.getClass().getDeclaredMethod("getTreeData", example.getClass());
			Object result = getTreeData.invoke(mapper, example);
			return (List<TreeNode>) result;
		}catch (Exception e) {
			DynamicDataSource.clearDataSource();
			throw new CommonException("countByExample exception");
		}
